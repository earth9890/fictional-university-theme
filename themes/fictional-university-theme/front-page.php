...
<div class="hero-slider">
  <div data-glide-el="track" class="glide__track">
    <div class="glide__slides">
      ...
      <?php
      $homepageSlideshow = new WP_Query(
        array(
          'posts_per_page' => -1,
          'post_type' => 'hmpage-slideshow'
        )
      );
        ...
        <div class="hero-slider__slide" style="background-image: url(<?php the_field('slide_image'); ?>);">
          <div class="hero-slider__interior container">
            <div class="hero-slider__overlay">
              ...
              <p class="t-center no-margin"><a href="<?php the_field('slide_link'); ?>"
                  class="btn btn--blue"><?php the_field('slide_link_text'); ?></a></p>
            </div>
          </div>
        </div>
